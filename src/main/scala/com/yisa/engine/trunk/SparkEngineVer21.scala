        ...
        try {
          taskType match {
            ...
            case CommonTaskType.SearchCarByPic => {
              SparkEngineModulesForVer21.SearchCarByPic(line, sparkSession, tableName, zkHostPort, cacheDays, tableNameAll,threadPool, prestoHostPort,prestoTableName, allYearidByBrandid , allYearidByModelid,AllYearids )
            }
            //相似车牌
