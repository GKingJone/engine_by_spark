        ...
        try {
          taskType match {
            ...
            case CommonTaskType.SearchSimilarPlate => {
              ...
              SparkEngineModules.SearchSimilarPlate(inittable2, line, sparkSession, threadPool, tableName, prestoTableName, zkHostPort, cacheDays_2, prestoHostPort)
            }
            //多点碰撞
            case CommonTaskType.MultiPoint => {
              ...
              SparkEngineModules.MultiPoint(inittable2, line, sparkSession, threadPool, tableName, prestoTableName, zkHostPort, cacheDays_2, prestoHostPort)
            ...
            case CommonTaskType.CaseCar => {
              ...
              SparkEngineModules.CaseCar(inittable2, line, sparkSession, threadPool, tableName, prestoTableName, zkHostPort, cacheDays_2, prestoHostPort)
            ...
            case CommonTaskType.EndStation => {
              ...
              SparkEngineModules.EndStation(inittable2, line, sparkSession, threadPool, tableName, prestoTableName, zkHostPort, cacheDays_2, prestoHostPort)
