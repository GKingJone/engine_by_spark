...
class SparkEngineV5ForMultiPoint_HBase2 extends Serializable {
      ...
      anayMap.foreach(e => {
        ...
        if (margeMap.contains(platenumber)) {
          ...
          if (capturetime > margeC) {
            ...
            var margeRe = margeTs + "_" + solrid + "_" + capturetime;
          ...
          var margeRe = taskId + "_" + solrid + "_" + capturetime
          margeMap += (platenumber -> margeRe)
        }
...
//        println("符合条件场合")
  ...
  def isOK(map: Array[InputBean], key: String, value: String): Boolean = {
    ...
    val levelid = value.split("_")(1)
    val brandid = value.split("_")(2)
    val modelid = value.split("_")(3)
    val yearid = value.split("_")(4)
    val direction = value.split("_")(5)
    val colorid = value.split("_")(6)
    val capturetime = value.split("_")(7)
