...
object SparkEngineModulesForVer5Alluxio {
  ...
  def FrequentlyCar(line: String, sparkSession: SparkSession, tableName: String, threadPool: ExecutorService, prestoTableName: String, frequentlyCarResultTableName: String, zkHostPort: String, cacheDays: Int, prestoHostPort: String, allLocations: ArrayBuffer[String]) {
    ...
    if (startTimeDateid <= getLCacheDataDateid(cacheDays).toInt) {
      ...
      val fcar = new SparkEngineV5ForFrequentlyCar_HBase()
      fcar.FrequentlyCarParallelized(sparkSession, line, tableName, frequentlyCarResultTableName, zkHostPort, allLocations)
  ...
  def SearchCarByPic_HBase(line: String, sparkSession: SparkSession, tableName: String, zkHostPort: String, cacheDays: Int, threadPool: ExecutorService, prestoHostPort: String, prestoTableName: String, allYearidByBrandid: Map[Int, Set[Long]], allYearidByModelid: Map[Int, Set[Long]], AllYearids: scala.collection.mutable.ArrayBuffer[String]) {
    var line_arr = line.split("\\|")
  ...
  def SearchCarByPic_Redis(line: String, sparkSession: SparkSession, tableName: String, zkHostPort: String, cacheDays: Int, threadPool: ExecutorService, prestoHostPort: String, prestoTableName: String, allYearidByBrandid: Map[Int, Set[Long]], allYearidByModelid: Map[Int, Set[Long]], AllYearids: scala.collection.mutable.ArrayBuffer[String]) {
    var line_arr = line.split("\\|")
